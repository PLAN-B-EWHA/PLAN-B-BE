package myexpressionfriend_api.child.repository;
 ...
 * Child Repository
 *
 * <p>Soft Delete 가 적용되어 기본 조회에서는 isDeleted=false 데이터만 조회됨</p>*/
public interface ChildRepository extends JpaRepository<Child, UUID> {

    /**
     * 게임 세션 생성 시 동시성 제어용 비관적 락 조회 (SELECT FOR UPDATE).
     *
     * <p>createSession 흐름에서만 사용하며, 반드시 쓰기 트랜잭션 안에서 호출해야 함</p>
     */
    ...
    /**
     * 아동 상세 조회 (권한 사용자 목록 + 사용자 정보 포함, N+1 방지)
     */
    @Query("""
